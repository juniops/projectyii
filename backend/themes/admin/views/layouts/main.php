                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span><?php //= Yii::$app->user->identity->profile->fullName ?> <i class="caret"></i></span>
                        </a>
...
<!--                                </p>-->
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <?= Html::a( Yii::t('themes', 'Sign out'), ['/users/user/logout'], ['class' => 'btn btn-default btn-flat'] ) ?>
                                </div>
                            </li>
                        </ul>
                    </li>
            ...
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <div class="pull-left info">
                        <p>
                            <?php //= Yii::t('themes', 'Hello, {name}', ['name' => Yii::$app->user->identity->profile->name]) ?>
                        </p>
                        <a>
